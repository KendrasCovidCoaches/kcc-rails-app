...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  protected
    ...
    def configure_account_update_params
      devise_parameter_sanitizer.permit(:account_update, keys: [:name, :about, :profile_links, :location, :phone, :affiliation, :remote_location, :newsletter_consent, :resume, :visibility, :pair_with_requests,  :level_of_availability, skill_list: []])
    end
